...
class Router implements RegistrarContract, BindingRegistrar
{
    ...
    public function auth()
    {
        ...
        $this->get('register-admin', 'Auth\RegisterAdminController@showRegistrationForm')->name('register-admin');
        $this->post('register-admin', 'Auth\RegisterAdminController@register');
